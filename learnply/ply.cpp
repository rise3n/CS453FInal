...
static const char *type_names[] = {  /* names of scalar types */
"invalid",
"int8", "int16", "int32", "uint8", "uint16", "uint32", "float32", "float64",
};

static const char *old_type_names[] = {  /* old names of types for backward compatability */
"invalid",
...
/* memory allocation */
static char *my_alloc(size_t, int, char *);
...
)
{
  switch (type) {
    ...
    case Uint32:
      *uint_val = (uint32_t)strtoul (word, (char **) NULL, 10);
      *int_val = *uint_val;
      *double_val = *uint_val;
      break;
...
static char *my_alloc(size_t size, int lnum, const char *fname)
{
  char *ptr;
...
static const RuleName rule_name_list[] = {
  AVERAGE_RULE, "avg",
  RANDOM_RULE, "rnd",
  MINIMUM_RULE, "max",
  MAXIMUM_RULE, "min",
