...
public:
	...
	Vertex **neighbors;
	int num_neighbors;
	int degreeInSuperLevelset;

public:
	Vertex() { x = 0; y = 0; z = 0; num_neighbors = -1; degreeInSuperLevelset = 0; } //default constructor taking no param
	Vertex(double xx, double yy, double zz) { x = xx; y = yy; z = zz; degreeInSuperLevelset = 0; }
	void findNeighbor();
};
